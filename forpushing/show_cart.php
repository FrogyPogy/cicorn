...
if($id != ""){
    ...
    //jika $_SESSION['cart'] dengan indeks isbn buku yang dipilih sudah ada, maka value dari indeks tersebut increment
        ...
        <div class="card-body">
            ...
            <table class="table table-striped">
                ...
                if (is_array($_SESSION['cart'])){
                    //melooping untuk seluruh elemen di dalam session
                    foreach ($_SESSION['cart'] as $id => $quantity){
                        ...
                        //menampilkan keseluruhan elemen
